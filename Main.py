...
def main(args, seed=None, fish=None):
    ...
    world.settings.create_from_world(world, args.race, args.seed_notes, args.seed_name)
...
def copy_world(world):
    ...
    ret = World(world.players, world.shuffle, world.doorShuffle, world.logic, world.mode, world.swords,
                ...
                world.accessibility, world.shuffle_ganon, world.custom, world.customitemarray, world.hints, args.seed_notes, args.seed_name)
